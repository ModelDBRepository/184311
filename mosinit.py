'''
Current clamp demo using Allen Brain's model 472912177.
...
from neuron472912177 import Neuron472912177
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472912177(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472912177; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-95.5370941162)
        h.fcurrent()
